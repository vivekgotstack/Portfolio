...
const sectionCopy: Record<(typeof pets)[number]["id"], Record<string, readonly string[]>> = {
  mochi: {
    ...
    work: ["These are functioning products, not courtly decoration: commerce, planning, AI email, and knowledge systems.", "ModaStitch shows production ownership; DamnTodo, ReplyCraft, and ChatSaver show range across real product problems.", "Each project combines useful interfaces with authentication, data flows, services, and deployment judgment."],
  ...
  byte: {
    ...
    work: ["No vaporware here. These projects manage real state, call services, and live beyond a tutorial tab.", "ModaStitch went to production; DamnTodo turns goals into schedules; ReplyCraft works inside Gmail; ChatSaver keeps knowledge private and synced.", "Different products, same rule: make the backend solid, the interface sharp, and the deployment real."],
  ...
  pip: {
    ...
    work: ["Each project is a lesson made tangible: secure flows, useful interfaces, connected services, and infrastructure working as one.", "ModaStitch, DamnTodo, ReplyCraft, and ChatSaver solve different problems through the same end-to-end discipline.", "Look beyond the screenshots: authentication, data, APIs, deployment, and user experience are all part of the work."],
