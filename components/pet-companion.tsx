...
const sectionCopy: Record<(typeof pets)[number]["id"], Record<string, readonly string[]>> = {
  mochi: {
    ...
    work: ["These are functioning products, not courtly decoration: commerce, finance, AI email, and knowledge systems.", "ModaStitch shows production ownership; CoinTracker, ReplyCraft, and ChatSaver show range across real product problems.", "Each project combines useful interfaces with authentication, data flows, services, and deployment judgment."],
  ...
  pip: {
    ...
    work: ["Each project is a lesson made tangible: secure flows, useful interfaces, connected services, and infrastructure working as one.", "ModaStitch, CoinTracker, ReplyCraft, and ChatSaver solve different problems through the same end-to-end discipline.", "Look beyond the screenshots: authentication, data, APIs, deployment, and user experience are all part of the work."],
