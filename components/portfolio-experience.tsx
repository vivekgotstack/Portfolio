      ...
      <main className="relative z-10">
        ...
        <section id="about" className="mx-auto max-w-[1440px] px-5 py-28 lg:px-12 lg:py-40">
          ...
          <div className="grid gap-4 md:grid-cols-12">
            <Reveal className="md:col-span-7"><div className="relative h-full min-h-80 overflow-hidden rounded-[2rem] border border-white/10 bg-white/[.035] p-7 sm:p-10"><p className="max-w-xl text-xl leading-relaxed tracking-[-.025em] text-white/75 sm:text-2xl">I work across the stack because great products break at the seams. From database design and authentication to interaction details and production deployment, I connect the whole system.</p><div className="absolute bottom-8 left-8 flex flex-wrap gap-2">{["Architecture", "API design", "Interface craft", "Deployment"].map(x => <span key={x} className="rounded-full border border-white/10 px-3 py-2 font-mono text-[9px] uppercase tracking-wider text-white/45">{x}</span>)}</div><div className="absolute -bottom-20 -right-20 h-64 w-64 rounded-full bg-[#c7ff38]/10 blur-3xl" /></div></Reveal>
            <Reveal className="md:col-span-5"><div className="grid h-full grid-cols-2 gap-4"><div className="rounded-[2rem] border border-white/10 bg-[#c7ff38] p-6 text-black"><p className="font-mono text-[9px] uppercase tracking-widest">Primary runtime</p><p className="mt-14 text-5xl font-semibold tracking-[-.06em]">Java<span className="text-black/35">21</span></p></div><div className="rounded-[2rem] border border-white/10 bg-white/[.035] p-6"><p className="font-mono text-[9px] uppercase tracking-widest text-white/35">Current role</p><p className="mt-14 text-xl font-medium">Web Developer</p><p className="mt-1 text-xs text-white/40">UP24Network</p></div><div className="col-span-2 flex items-center justify-between rounded-[2rem] border border-white/10 bg-white/[.035] p-6"><div><p className="font-mono text-[9px] uppercase tracking-widest text-white/35">Location</p><p className="mt-2 flex items-center gap-2 text-lg"><MapPin className="h-4 w-4 text-[#c7ff38]" /> India / Remote</p></div><Image src="/pfp.jpg" width={72} height={72} alt="Vivek Nigam" className="h-16 w-16 rounded-full border border-white/15 object-cover grayscale transition hover:grayscale-0" /></div></div></Reveal>
          </div>
        </section>
