Create one horizontal animation strip for Codex pet `pip`, state `running-right`.
...
Identity: same pet in every frame: Saintly meditating brown monkey with cream beard, golden forehead light, prayer beads and small golden vessel; serene spiritual persona; preserve exact face, palette, seated lotus pose language, accessories, proportions and pixel-block style; remove only the dark gradient and glow background; no redesign or new props.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
